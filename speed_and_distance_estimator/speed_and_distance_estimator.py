...
class SpeedAndDistanceEstimator():
    def __init__(self):
        self.frame_window = 5 # calculate speed of player every 5 frames
        self.frame_rate = 24
    ...
    def add_speed_and_distance_to_tracks(self,tracks):
        ...
        for object, object_tracks in tracks.items():
            ...
            for frame_num in range(0,number_of_frames, self.frame_window):
                last_frame = min(frame_num+self.frame_window,number_of_frames-1) # prevent out of bounds
            ...
            for object, object_tracks in tracks.items():
                ...
                for _, track_info in object_tracks[frame_num].items():
                    if 'speed' in track_info:
                        ...
                        position[1] += 40 # 40 pixel buffer to not clash with other annotations
